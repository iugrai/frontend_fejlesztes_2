...
import TodoCounter from './TododCounter';
import TodoItem from './TodoItem';

const AddTodo = () => {
  // destructuring: (a useState egy tömböt add vissza, az első egy változó, a második egy fgv. amivel ezt a változót tudom módosítani)
  // const temp = useState('');
  // const todo = temp[0];
